...
import io.sandstorm.controller.portadapter.persist.mgo.EntityIdCodec;
...
public class MongoClientOptionsFactoryBean extends AbstractFactoryBean<MongoClientOptions> {
    ...
    /**
     * Set the {@link WriteConcern} that will be the default value used when asking for a DB
     * object.
     *
     * @param writeConcern
     */
